...
*/
    ...
    let tables = $('#employee').DataTable({
        ajax: {
            url: "https://localhost:7230/api/Employee/GetIdByRole?role=1",
            dataType: "Json",
...
$(function () {
    $("#formValidation").validate({
        ...
        messages: {
            ...
            first_name: {
                required: "<p style='font-size: 12px; color: red; margin-bottom:-50px;'>*Please enter your first name</p>"
            },
            last_name: {
                required: "<p style='font-size: 12px; color: red; margin-bottom:-50px;'>*Please enter your last name</p>"
            },
            gender: {
                required: "<p style='font-size: 12px; color: red; margin-bottom:-50px;'>*Please choose your gender</p>"
            },
            BirthDate: {
                required: "<p style='font-size: 12px; color: red; margin-bottom:-50px;'>*Please enter your birthdate</p>"
            },
            Email: {
                required: "<p style='font-size: 12px; color: red; margin-bottom:-50px;'>*Please enter your email</p>",
                email: "<p style='font-size: 12px; color: red; margin-bottom:-50px;'>*The email should be in the format: abc@domain.tld</p>"
            },
            Password: {
                required: "<p style='font-size: 12px; color: red; margin-bottom:-50px;'>*Please enter your password</p>"
            },
            Role: {
                required: "<p style='font-size: 12px; color: red; margin-bottom:-50px;'>*Please choose your role</p>"
            },
            IsActive: {
                required: "<p style='font-size: 12px; color: red; margin-bottom:-50px;'>*Please enter your IsActive</p>"
            }
        }
    });
});
...
const Delete = (id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: 'DELETE',
                url: `https://localhost:7230/api/Employee?id=${id}`,
                success: () => {
                    Swal.fire(
                        'Deleted',
...
function Update(nik) {
    ...
    $.ajax({
        url: "https://localhost:7230/api/Employee/id?id=" + nik,
...
function UpdateData() {
    ...
    edt.Password = $("#inputPassword").val();
    edt.Role = 1 ;
    edt.IsActive = true,
    console.log(edt);
